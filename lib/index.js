var myhttp = require('/home/chris/ttbot/http-get');
...
Lastfm.prototype.scrobbleTrack = function(options) {
...
//	session.scrobbled = true;
	...
	console.log("Using session key: " + settings.lastfm_session_key + "\n\n");
	var authToken = md5(this.username + md5(this.password));
//	console.log("authToken = " + authToken);
	var sig = 'api_key' + this.api_key + 'artist' + options.artist + 'method' + options.method + 'sk' + settings.lastfm_session_key + 'timestamp' + options.timestamp + 'track' + options.track + this.api_secret;
//	console.log("sig = " + sig);
	var api_sig = md5(sig);
